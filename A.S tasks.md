...
- ✅ Header. *(Full-bleed Augsburg Town Hall hero in the Tailor-made style: translucent green-accented box with H1 "A Germany specialist for the travel trade", a short intro, and a "Make a trade enquiry" button that deep-links to /contact/?enquiry=business — which opens straight on the Business/Trade form.)*
